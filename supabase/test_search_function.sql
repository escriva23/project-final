-- Test script to create just the search_services_optimized function
-- This will help isolate any dependency issues
...
SELECT 'search_services_optimized function created successfully' as status;
