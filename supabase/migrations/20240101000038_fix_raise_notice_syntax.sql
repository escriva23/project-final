-- Fix RAISE NOTICE syntax error in diagnostic script
-- The issue is a missing parameter for the % placeholder
...
BEGIN
    ...
    IF NOT found_result THEN
        RAISE NOTICE 'No results found for user %. Checking reasons...', target_user_id;
